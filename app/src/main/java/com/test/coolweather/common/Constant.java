package com.test.coolweather.common;
...
public class Constant {
    ...
    public final static String FAILED_LOAD = "加载失败";

    public final static String LOADING = "正在加载...";

    public final static String COUNTRY = "中国";

    public final static String FAILED_GET_WEATHER = "获取天气信息失败";

    public final static String FAILED_GET_PIC = "获取图片失败";
}
